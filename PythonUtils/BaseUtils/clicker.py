...
"""
Counter object to count clicks
"""
...
class Clicker(object):
    ...
    Keyword Arguments:
        ...
        max_value (int): [sys.maxsize] maximum possible counter number, when set echo will return %xx and number stops
            at max
    ...
    def add_counter(self, name, **kwargs):
        ...
        *if not passed, keyword params will use the base* :class:`Clicker` *settings*
        ...
        Keyword Arguments:
            ...
            max_value: [sys.maxsize] maximum possible counter number, when set echo will return %xx and number stops at
                max
