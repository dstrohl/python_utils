...
def interpolate(in_string,
    ...
    :param in_string: the initial string to parse, if this is not a string, we will return it as it is with no processing.
    ...
    :param key_enc: Default: "()", Defines the enclosure that the keys will be in.  this needs to be a 2 char string, with the
        characters being the first and last character of the enclosure.  these cannot be duplicates and cannot be
        characters that will show up in the string.  examples:  "()" or "{}" or "[]".
    ...
    while rest:
        ...
        if c == key:
            ...
            if on_key_error == 'raise':
                ...
                recursive_path = int_field_map.make_path_from_key(m)
